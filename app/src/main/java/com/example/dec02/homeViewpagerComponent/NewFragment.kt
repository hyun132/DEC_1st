...
import kotlinx.android.synthetic.main.fragment_today.today_recyclerview
...
class NewFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val clothesRecyclerViewAdapter=ClothesRecyclerViewAdapter(clotheItem)
        ...
        clothesRecyclerViewAdapter.setItemClickListener(object :ClothesRecyclerViewAdapter.ItemClickListener{
            override fun onClick(view: View, position: Int) {
                ...
                intent.putExtra("uri",clotheItem[position].detail_url)
                startActivity(intent)

            }
        })

        Glide.with(activity!!).load("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQosc1-lM3fS8h6Wt_-qAksM4h0GypcyR7Hkw&usqp=CAU").into(mid_ad)
    }
